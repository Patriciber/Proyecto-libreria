    ...
    def __init__(self):
        self._books = [
            Book(
                ...
                content="Capítulo 1: El Vacío Brillante. Las naves de carga cruzaban el cinturón de asteroides con la elegancia de ballenas plateadas. Elena miraba por la escotilla, sabiendo que el horizonte que conocía se había perdido para siempre...",
                is_favorite=False
            ),
            Book(
                ...
                content="Introducción al Código Limpio. No basta con que el código funcione. El código debe ser legible, mantenible y elegante. En este libro exploraremos los principios de S.O.L.I.D y cómo aplicarlos en el día a día...",
                is_favorite=True
            ),
            Book(
                ...
                content="Las nubes sobre Celestyra eran de un color púrpura antinatural. El Rey de las Sombras había despertado, y con él, un ejército de espectros que no conocían el miedo ni la piedad. Marc empuñó su espada rúnica...",
                is_favorite=False
            ),
            Book(
                ...
                content="Capítulo 1: La Neuroplasticidad. ¿Es posible cambiar la forma en que pensamos? La ciencia moderna nos dice que sí. A través de ejercicios mentales constantes, podemos reconfigurar nuestras sinapsis...",
                is_favorite=False
            ),
            Book(
                ...
                content="En el laboratorio de partículas, Lucía observaba el monitor de entrelazamiento. No era solo energía lo que se transfería; sentía una conexión pulsante con una versión de sí misma en otra dimensión...",
                is_favorite=False
            ),
            Book(
                ...
                content="La vieja mansión de los Blackwood guardaba un secreto bajo el suelo de roble. Cuando el inspector retirado bajó al sótano, el olor a papel antiguo y humedad le confirmó que el enigma no era una leyenda...",
                is_favorite=True
            ),
            Book(
                ...
                content="La luz roja del sol golpeaba los domos de cristal de New Hope. Noah suspiró al ver que la cosecha hidropónica finalmente brotaba, un pequeño milagro verde en un mundo muerto pero lleno de promesas...",
                is_favorite=False
            ),
            Book(
                ...
                content="En las cámaras ocultas de Versalles, Ana encontró el diario de Isabel la Audaz. Sus páginas describían no solo el lujo de la corte, sino la astucia de una mujer que gobernó en la sombra durante décadas...",
                is_favorite=False
            ),
            Book(
                ...
                content="Capítulo 1: El Mindset Global. Escalar un negocio hoy en día ya no se trata de geografía, sino de conectividad. Carlos Mateo desgrana cómo las startups pueden nacer globales desde su primer día...",
                is_favorite=True
            ),
            Book(
                ...
                content="Las antorchas parpadeaban en los pasillos de piedra. Lena sabía que si llegaba al corazón de la Ciudadela antes del amanecer, la verdad sobre la desaparición de los Ancianos saldría a la luz...",
                is_favorite=False
            ),
            Book(
                ...
                content="Ejercicio 1: El Espejo Interior. Mírate no como los demás te ven, sino como eres en esencia. Mariana nos guía a través de técnicas de introspección que revelan nuestra verdadera fuerza emocional...",
                is_favorite=False
            ),
            Book(
                ...
                content="La tecnología no es solo una herramienta de eficiencia; es un pincel digital. Tomás explora cómo la inteligencia artificial y el diseño paramétrico están abriendo nuevas fronteras para los creativos...",
                is_favorite=False
            ),
        ]
