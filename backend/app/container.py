...
from app.adapters.repositories.author_repository_mock import AuthorRepositoryMock
...
class DependencyContainer:
    ...
    def __init__(self):
        ...
        self._author_repository: AuthorRepositoryPort = None
    ...
    @property
    def author_repository(self) -> AuthorRepositoryPort:
        """Lazy initialization del repositorio de autores."""
        if self._author_repository is None:
            self._author_repository = AuthorRepositoryMock()
...
def get_author_repository() -> AuthorRepositoryPort:
    """Factory function para obtener el repositorio de autores."""
    return container.author_repository
